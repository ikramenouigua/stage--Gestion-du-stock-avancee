...
<body class="main-container" style="background-color : white;" id="commande">
...
<div class="pull-right">
                <a class="btn btn-primary" href="{{ route('commande.index') }}" id="back"> Back</a>
            </div>
@if ($errors->any())
...
<form action="{{ route('commandec.update',$commandes) }}" method="POST">
        @csrf
        @method('PUT')
 <div class="row">
 <div class="form-group">
              ...
              @foreach($lignes as $product)
						    <tr class="alert" role="alert" id="{{ 'pdt'.$product->id }}">
						    	...
						    	<td>
						    	<img class="img" src="{{ asset('/storage/images/products/' . $product->image_produit) }}" style="width:60px;height:60px; aligne:center;background-color:transparent;" id="check">
						    	</td>
						      <td>
